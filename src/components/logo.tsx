...
export function Logo({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center gap-3 text-lg font-bold font-headline select-none", className)}>
      <div className="bg-slate-950 text-primary p-2.5 rounded-xl shadow-2xl border-2 border-primary/20 flex items-center justify-center transform -rotate-6 transition-transform hover:rotate-0 group shrink-0">
          <Wrench className="h-6 w-6 stroke-[3px] group-hover:scale-110 transition-transform" />
      </div>
