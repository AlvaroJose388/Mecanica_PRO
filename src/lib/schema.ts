...
export const users = pgTable('users', {
  ...
  workshopId: varchar('workshop_id', { length: 255 }).references(() => workshops.id, { onDelete: 'set null' }),
...
export const workshops = pgTable('workshops', {
  id: varchar('id', { length: 255 }).primaryKey(),
  name: varchar('name', { length: 255 }).notNull(),
  ownerId: varchar('owner_id', { length: 255 }).notNull().references(() => users.id, { onDelete: 'set null'}),
...
export const technicalProtocols = pgTable('technical_protocols', {
    ...
    steps: jsonb('steps').notNull(), // Almacena array de strings
